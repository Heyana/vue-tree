...
declare const _default: import("vue").DefineComponent<{
    ...
    beforeDropMethod: {
        type: PropType<(dragNode: TreeNode, dropNode: TreeNode | null, hoverPart: dragHoverPartEnum) => boolean>;
        default: () => () => true;
    };
    /** 忽略模式 */
    ignoreMode: {
    ...
    beforeDropMethod: (dragNode: TreeNode, dropNode: TreeNode | null, hoverPart: dragHoverPartEnum) => boolean;
    autoLoad: boolean;
    loading: boolean;
